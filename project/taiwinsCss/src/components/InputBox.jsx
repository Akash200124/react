    ...
    return (
        <div className={`bg-white p-3 rounded-lg text-5m flex ${className} `}>
            ...
            <div className="w-1/2 flex flex-wrap justify-end text-right">
                ...
                <select
                    className="border-2 rounded-lg px-1 py-1 bg-gray-100 cursor-pointer outline-none text-black"
                ...
                >
                    ...
                    {currencyOption && currencyOption.filter((curr => curr != selectCurrency)).map((currency) => (
